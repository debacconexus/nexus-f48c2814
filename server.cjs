...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "University Student Success Coordination Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Student Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "student_record_records";
'use strict';
